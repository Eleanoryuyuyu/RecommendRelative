...
def get_data(file_path, out_prefix):
  percent = 0.7
  user2id_map = dict()
  item2id_map = dict()
  userId = 0
  ...
  with open(file_path, 'r') as inpt_f: #ratings.csv headers: userId,movieId,rating,timestamp
    for line in inpt_f:
      if 'userId' in line:
        continue
...
if __name__ == "__main__":
  file_path = "/home/yangjieyu/yjy/RecommendRelative/recallModels/ml-1m/ratings.dat"
  out_prefix = "/home/yangjieyu/yjy/RecommendRelative/recallModels/ml-1m/ml"
  get_data(file_path, out_prefix)
